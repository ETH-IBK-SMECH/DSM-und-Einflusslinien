...
for i = 1:numel(StabLast_konz)
    ...
    switch dir
        case {1, 2}
            ...
            text(ax, p0(1), p0(2), num2str(abs(StabLast_konz(i).Wert)), ...
                'Parent', hg, ...
                'FontSize', 14, ...
                'Margin', 1, ...
        ...
        case 3
             ...
             text(ax, base(1), base(2), num2str(abs(StabLast_konz(i).Wert)), ...
                 'Parent', hg, ...
                 'FontSize', 14, ...
    ...
    'DisplayName', sprintf('Konz. Stablast S%d', StabIdx)); % Namensgebung vlt anpassen.

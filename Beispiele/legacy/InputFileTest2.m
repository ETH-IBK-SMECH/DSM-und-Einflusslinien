...
%AUSFÜLLEN
EModul = [200,200,200,200]';
nQuerschnitte = size(EModul,1);
Flaeche = [0.2,0.2,0.2,0.2]'; %beliebig
Traegheitsmoment = [0.16,0.16,0.16,0.16]'; %beliebig
GelenkStabAnfang = [0,0,0,0]';  
GelenkStabende   = [0,0,0,0]';

classdef TestI_FixedFixedBeam < matlab.unittest.TestCase
    ...
    methods (Test)
            ...
            for i = 1:size(cases, 1)
                ...
                if expectSym
                    ...
                    if haveRy
                        ...
                        m1 = 0;
                        if ~isempty(r1m), m1 = r1m(1).Reaktion;
                        end
                        m2 = 0;
                        if ~isempty(r2m), m2 = r2m(1).Reaktion;
                        end
        ...
        function rotation_invariance_local(tc)
            ...
            Mr.Knoten(1).x = 0;
            Mr.Knoten(1).y = 0;
            Mr.Knoten(2).x = L * cos(theta);
            Mr.Knoten(2).y = L * sin(theta);
            ...
            K0 = out0.Stab(1).k_loc;
            R0 = out0.Stab(1).R;
            Kr = outr.Stab(1).k_loc;
            Rr = outr.Stab(1).R;
